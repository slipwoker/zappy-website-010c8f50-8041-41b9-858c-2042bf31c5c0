  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if (field.hasAttribute('minlength') && !validators.minlength(value, field.getAttribute('minlength'))) {
        return label.trim() + ' must be at least ' + field.getAttribute('minlength') + ' characters.';
      }
...
/* SIGNATURE MOMENT: magnetic-cta-glow */
(function(){

      (function(){
        if (window.matchMedia && window.matchMedia('(prefers-reduced-motion: reduce)').matches) return;
        document.querySelectorAll('.btn-primary, .cta-primary, .btn.btn-primary').forEach(function(el){
          el.addEventListener('mousemove', function(e){ var r = el.getBoundingClientRect(); el.style.setProperty('--zsm-x', ((e.clientX - r.left) / r.width * 100) + '%'); el.style.setProperty('--zsm-y', ((e.clientY - r.top) / r.height * 100) + '%'); });
        });
      })();
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '010c8f50-8041-41b9-858c-2042bf31c5c0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '010c8f50-8041-41b9-858c-2042bf31c5c0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '010c8f50-8041-41b9-858c-2042bf31c5c0';
